...
- Rows: 200
- Split: all
- Taxonomy primary matches: 129/137
- Taxonomy ready matches: 163/200
- Similarity status matches: 200/200
- Any-overlap rows: 196
- Zero-overlap rows: 4
- Live-empty rows: 4
- Must-include recall: 260/383
- Must-avoid hits: 0
- Improved rows: 86
- Worsened rows: 0
- Missing anchors: 0
...
- Live: Hidden Cats in Paris, 100 hidden Cats: Ninja
- Gold: Hidden Cats in Paris, 100 hidden Cats: Ninja
- Overlap: `2`
- Missing must-include: A Castle Full of Cats, An Arcade Full of Cats
- Delta overlap: `0` improved=false worsened=false

### Avenue Escape

- Taxonomy: current `traffic_puzzle` vs gold `none`
- Live: Urban Flow, Mini Motorways
- Gold: Urban Flow, Mini Motorways, Train Valley 2: Community Edition
- Overlap: `2`
- Missing must-include: Does not Commute
- Delta overlap: `2` improved=true worsened=false

### Fly for Fly

- Taxonomy: current `mischief_sandbox_sim` vs gold `none`
- Live: Rain on Your Parade, Untitled Goose Game
- Gold: Mister Mosquito, Rain on Your Parade, Untitled Goose Game
- Overlap: `2`
- Missing must-include: Mr. Moskeeto
- Delta overlap: `2` improved=true worsened=false
