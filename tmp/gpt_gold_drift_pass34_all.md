...
- Live unsafe rows: 0
- Worsened rows: 1
- Live-empty expected-computed rows: 27
...
- `hidden -> monster_collect_rpg`: 1
- `hidden -> visual_novel`: 1
- `hidden -> action_platformer`: 1
- `card_battler -> none`: 1
