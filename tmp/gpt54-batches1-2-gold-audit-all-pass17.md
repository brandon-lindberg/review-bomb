...
- Rows: 200
- Split: all
- Taxonomy primary matches: 107/137
- Taxonomy ready matches: 159/200
- Similarity status matches: 161/200
- Any-overlap rows: 143
- Zero-overlap rows: 57
- Live-empty rows: 43
- Must-include recall: 198/383
- Must-avoid hits: 50
- Improved rows: 22
- Worsened rows: 0
- Missing anchors: 0
...
- `Reach`: 1
- `Trek to Yomi`: 1
- `Harold Rabbit - Finder of Lost Things`: 1
- `Midnight Girl`: 1
- `The Order of the Thorne - The King's Challenge`: 1
- `Unicorn Dungeon`: 1
- `Watch Over Christmas`: 1
- `Alan Wake 2`: 1
...
- Taxonomy: current `open_world_action_adventure` vs gold `metroidvania`
- Live: Tales of Arise, Mable and the Wood, Curse of the Sea Rats, Inayah: Life After Gods, Mandragora: Whispers of the Witch Tree, Blow It Up, Tribes of Midgard, KAKU: Ancient Seal, Dark Souls III, Dragon's Dogma: Dark Arisen
...
- Must-avoid hits: Tales of Arise
- Delta overlap: `0` improved=false worsened=false
