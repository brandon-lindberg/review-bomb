...
- Similarity status matches: 49/50
- Any-overlap rows: 40
- Zero-overlap rows: 10
- Live-empty rows: 3
- Must-include recall: 74/137
- Must-avoid hits: 24
- Improved rows: 8
- Worsened rows: 0
- Missing anchors: 0
...
- Taxonomy: current `mischief_sandbox_sim` vs gold `none`
- Live: Goat Simulator 3, Untitled Goose Game, Catlateral Damage: Remeowstered
- Gold: Goat Simulator 3, Catlateral Damage: Remeowstered, Untitled Goose Game
- Overlap: `3`
- Delta overlap: `3` improved=true worsened=false
