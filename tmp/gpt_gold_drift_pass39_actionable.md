...
- Live unsafe rows: 0
- Worsened rows: 1
- Live-empty expected-computed rows: 19
...
- Similarity status: current `computed` vs expected `computed`
- Overlap: `4`
- Live: Bug Fables: The Everlasting Sapling, Omori, Persona 4 Golden, Ikenfell
