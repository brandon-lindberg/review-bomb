...
- Rows: 200
- Split: all
- Taxonomy primary matches: 108/137
- Taxonomy ready matches: 159/200
- Similarity status matches: 161/200
- Any-overlap rows: 147
- Zero-overlap rows: 53
- Live-empty rows: 43
- Must-include recall: 201/383
- Must-avoid hits: 44
- Improved rows: 26
- Worsened rows: 0
- Missing anchors: 0
...
- Taxonomy: current `western_narrative_rpg` vs gold `open_world_action_adventure`
