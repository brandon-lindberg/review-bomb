...
- Live unsafe rows: 0
- Worsened rows: 1
- Live-empty expected-computed rows: 11

## Bucket Summary

- `must_include_gap`: 71
- `low_overlap_live`: 14
- `similarity_status_drift`: 10
- `catalog_gap_risk`: 3
- `regression`: 1
...
- Taxonomy: current `co_op_action_roguelite` vs gold `none`
- Similarity status: current `hidden` vs expected `computed`
- Overlap: `0`
