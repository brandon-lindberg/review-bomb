...
- Rows: 50
- Split: validation
- Taxonomy primary matches: 39/42
- Taxonomy ready matches: 49/50
- Similarity status matches: 44/50
- Any-overlap rows: 35
- Zero-overlap rows: 15
- Live-empty rows: 8
- Must-include recall: 59/137
- Must-avoid hits: 24
- Improved rows: 3
- Worsened rows: 0
- Missing anchors: 0
...
- Taxonomy: current `precision_platformer` vs gold `precision_platformer`
- Live: none
...
- Delta overlap: `1` improved=true worsened=false
