...
- Similarity status matches: 45/50
- Any-overlap rows: 36
- Zero-overlap rows: 14
- Live-empty rows: 7
- Must-include recall: 62/137
- Must-avoid hits: 24
- Improved rows: 4
- Worsened rows: 0
- Missing anchors: 0
...
- Taxonomy: current `transport_sim` vs gold `transport_sim`
- Live: Train Sim World 5, Train Sim World 4
- Gold: Train Sim World 5, Train Sim World 4
- Overlap: `2`
- Delta overlap: `0` improved=false worsened=false
