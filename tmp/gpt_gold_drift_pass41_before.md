...
- Live unsafe rows: 0
- Worsened rows: 1
- Live-empty expected-computed rows: 4

## Bucket Summary

- `must_include_gap`: 73
- `low_overlap_live`: 14
- `similarity_status_drift`: 3
- `catalog_gap_risk`: 3
- `regression`: 1
...
- `cinematic_puzzle_adventure -> none`: 1
...
- Priority: `100`
- Action: `rebuild_publish_after_taxonomy_fix`
- Taxonomy: current `cinematic_puzzle_adventure` vs gold `none`
- Similarity status: current `hidden` vs expected `computed`
- Overlap: `0`
