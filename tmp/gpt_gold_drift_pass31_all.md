...
- Live unsafe rows: 1
- Worsened rows: 1
- Live-empty expected-computed rows: 36

## Bucket Summary

- `aligned`: 84
- `must_include_gap`: 61
- `similarity_status_drift`: 19
- `taxonomy_backlog`: 16
- `low_overlap_live`: 16
- `catalog_gap_risk`: 2
- `regression`: 1
...
- `hidden -> monster_collect_rpg`: 2
- `hidden -> character_action`: 2
...
- `hidden -> cinematic_action_adventure`: 1
...
- `Silica`: 1
- `Garden Life: A Cozy Simulator`: 1
...
- Priority: `134`
- Action: `repair_lane_or_block_bad_pool`
- Taxonomy: current `monster_collect_rpg` vs gold `monster_collect_rpg`
- Similarity status: current `computed` vs expected `computed`
- Overlap: `0`
- Live: Digimon Story: Time Stranger, Rune Factory 4 Special, Puzzle Quest: Immortal Edition, Monster Hunter Stories, Coromon, Abomi Nation, Bloomtown: A Different Story, Dungeon Travelers: To Heart 2 in Another World, Onigo Hunter, Rune Factory 5
...
- Similarity status: current `computed` vs expected `computed`
- Overlap: `1`
- Live: Tomb Raider, GreedFall, Dragon Quest Heroes: The World Tree's Woe and the Blight Below, The Legend of Zelda: Tears of the Kingdom, God of War, Warhammer: End Times - Vermintide, Crimson Desert, Reach, Trek to Yomi, God of War Ragnarök
...
- Similarity status: current `computed` vs expected `computed`
- Overlap: `1`
- Live: SteamWorld Dig 2, Gato Roboto, Xeodrifter, Bō: Path of the Teal Lotus, Webbed, Everdeep Aurora, Ori and the Will of the Wisps, Genopanic, MIO: Memories in Orbit, Öoo
...
- Similarity status: current `computed` vs expected `computed`
- Overlap: `1`
- Live: Yoru ga Kuru! -Square of the Moon- Remastered, Loop8: Summer of Gods, Tales of Arise, The Legend of Heroes: Trails of Cold Steel, Beast Breaker, Clair Obscur: Expedition 33, Chrono Cross: The Radical Dreamers Edition, Bravely Default: Flying Fairy HD Remaster, Kingdom Come: Deliverance II, Lunar Remastered Collection
- Gold: Tales of Berseria, Tales of Arise, Tales of Zestiria, Tales of Vesperia: Definitive Edition, Scarlet Nexus
- Missing must-include: Tales of Berseria, Tales of Zestiria
