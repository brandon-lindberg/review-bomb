...
- Actionable rows: 91
- Validation actionable rows: 28
- Live unsafe rows: 0
- Worsened rows: 0
- Live-empty expected-computed rows: 0
...
- `hidden -> none`: 8
- `physics_roguelite_strategy -> none`: 2
- `merge_puzzle -> none`: 2
- `cinematic_puzzle_adventure -> survival_horror`: 2
- `pending -> none`: 2
- `co_op_action_roguelite -> none`: 2
- `card_battler -> none`: 1
- `3d_collectathon -> precision_platformer`: 1
- `tower_defense_strategy -> none`: 1
- `shoot_em_up -> none`: 1
- `co_op_horror -> survival_horror`: 1
- `loot_action_rpg -> none`: 1
- `rhythm_game -> action_platformer`: 1
- `hidden_object_puzzle -> none`: 1
- `traffic_puzzle -> none`: 1
...
- Priority: `81`
- Action: `seed_missing_catalog_neighbors_or_keep_hidden`
- Taxonomy: current `colony_sim` vs gold `colony_sim`
- Similarity status: current `computed` vs expected `computed`
- Overlap: `1`
- Live: The Riftbreaker
- Gold: The Riftbreaker
- Missing must-include: Executive Assault 2, Silica
...
- Priority: `40`
- Action: `improve_ranking_without_broadening_weak_matches`
- Taxonomy: current `tower_defense_strategy` vs gold `none`
- Similarity status: current `computed` vs expected `computed`
- Overlap: `1`
- Live: Isle of Arrows
- Gold: Isle of Arrows
...
- Similarity status: current `computed` vs expected `computed`
- Overlap: `2`
- Live: Highway Blossoms, Nurse Love Addiction
...
- Priority: `32`
- Action: `boost_canonical_neighbors`
- Taxonomy: current `co_op_horror` vs gold `survival_horror`
- Similarity status: current `computed` vs expected `computed`
- Overlap: `3`
...
- Similarity status: current `computed` vs expected `computed`
- Overlap: `3`
- Live: Fatal Frame: Maiden of the Black Water, Fatal Frame: Mask of the Lunar Eclipse, DreadOut
- Gold: Fatal Frame: Mask of the Lunar Eclipse, Fatal Frame: Maiden of the Black Water, DreadOut
- Missing must-include: Fatal Frame II: Crimson Butterfly, Fatal Frame: Maiden of Black Water
...
- Priority: `26`
- Action: `boost_canonical_neighbors`
- Taxonomy: current `cinematic_puzzle_adventure` vs gold `survival_horror`
- Similarity status: current `computed` vs expected `computed`
- Overlap: `4`
...
- Priority: `24`
- Action: `boost_canonical_neighbors`
- Taxonomy: current `loot_action_rpg` vs gold `none`
- Similarity status: current `computed` vs expected `computed`
- Overlap: `2`
- Live: EVERSPACE 2, Rebel Galaxy Outlaw
...
- Similarity status: current `computed` vs expected `computed`
- Overlap: `2`
- Live: God of War, Ryse: Son of Rome, Kena: Bridge of Spirits, Hellblade: Senua's Sacrifice, A Plague Tale: Innocence, A Plague Tale: Requiem
- Gold: God of War, Star Wars Jedi: Fallen Order, Kena: Bridge of Spirits, Black Myth: Wukong
- Missing must-include: Star Wars Jedi: Fallen Order
...
- Similarity status: current `computed` vs expected `computed`
- Overlap: `4`
- Live: Summer in Mara, Moonglow Bay, Stardew Valley, Animal Crossing: New Horizons
...
- Similarity status: current `computed` vs expected `computed`
- Overlap: `5`
- Live: Chained Echoes, Asdivine Hearts, Rise of the Third Power, Revenant Saga, Ara Fell: Enhanced Edition
- Gold: Asdivine Hearts, Revenant Saga, Rise of the Third Power, Chained Echoes, Ara Fell: Enhanced Edition
- Missing must-include: Asdivine Hearts II
